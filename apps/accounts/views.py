...
from agrosite.utils import send_email, get_md5, get_current_site
...
def account_result(request):
    ...
    if type and type in ['register', 'validation']:
        if type == 'register':
            content = '''
    Congratulations on your successful registration, a verification email has been sent to you {email} the mailbox, please verify your mailbox after logging in to this site。
    '''.format(email=user.email)
            ...
            user.save()
            content = '''
            Congratulations on your successful mailbox verification, you can now use your account number to log in to this site。
            '''
